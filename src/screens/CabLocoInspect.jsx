...
const partDescriptions = [
   "Assistant door",
   "Assistant door windscreen",
   "Assistant door windscreen wiper motor",
   "Safety control vigilance switch",
   "Assistant chair /seat",
   "B-side arm rest",
   "B-side sliding window assembly",
   "Behind assistant windscreen",
   "Behind assistant windscreen wiper motor",
   "B-side windscreen wiper control valve"
];
...
const CabLocoInspect = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("http://41.87.206.94/AVIapi/api/CabLocoInspect/submit", payload);
