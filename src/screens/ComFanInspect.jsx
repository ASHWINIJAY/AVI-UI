...
const partDescriptions = [
   ...
   "Intercooler",
   "60Psi compressor safety valve",
   "GD80 air intake filter",
   "Compressor oil separator",
   "Compressor drain cut out cock",
   "Main air reservoir No.1",
   "Main air reservoir No.2",
   "Heat exchanger",
   "Auto drain Valve"
];
...
const ComFanInspect = () => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      UserID : userID,
      InspectFormID: "CFI001",
      Rows: formattedRows,
    };
    try {
      await axios.post("http://41.87.206.94/AVIapi/api/ComFanInspect/submit", payload);
