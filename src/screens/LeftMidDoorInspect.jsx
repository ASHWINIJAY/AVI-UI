...
const partDescriptions = [
   ...
   "Turbo Lube pump circuit breaker 2 pole 30Amp",
   "Module circuit breaker",
   "Fuel pump Test Switch 2 pole 20 Amp toggle",
   "Dirt Exhauster Circuit Breaker 2 pole",
...
const LeftMidDoorInspect = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("http://41.87.206.94/AVIapi/api/LeftMidDoorInspect/submit", payload);
