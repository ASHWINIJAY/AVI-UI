...
const CoupGearInspect = () => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      UserID : userID,
      InspectFormID: "CGI001",
      Rows: formattedRows,
    };
    try {
      await axios.post("http://41.87.206.94/AVIapi/api/CoupGearInspect/submit", payload);
...
export default CoupGearInspect;
