...
const partDescriptions = [
   ...
   "Dynamic Braking Grid Resistor A-side, A5 Common grid",
   "Dynamic Braking Grid Resistor A-side, A3 Motor grid",
   "Dynamic braking grid resistor cover, A-Side",
   "16-645E3 Engine",
   "Turbo Charger ",
   "Turbo Air box, A-side",
   "Turbo Aftercooler, A- Side",
   "Engine baring device Stand"
];
...
const EngineDeckInspect = () => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      UserID : userID,
      InspectFormID: "EDI001",
      Rows: formattedRows,
    };
    try {
      await axios.post("http://41.87.206.94/AVIapi/api/EngineDeckInspect/submit", payload);
...
export default EngineDeckInspect;
