...
const partDescriptions = [
   ...
   "RVR 21 transfer switch",
   "M16 Transfer switch",
   "B21 Braking Transfer switch",
   "B31 Braking Transfer switch",
   "P12 power contactor",
   "P34 Power contactor",
   "P56 Power Contactor",
   "B-power contactor",
   "FS1A field shunting contactor"
];
...
export default BotLeftPanInspect;
